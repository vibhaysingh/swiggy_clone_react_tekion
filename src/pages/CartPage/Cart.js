                ...
                <div className={styles.cart_container}>
                    <div className={styles.delivery_details}>
                        <div className={styles.accountPage}>
                            ...
                            {!currentUser && <div className={styles.accountDescription}>To place your order now, log in to your existing account or sign up.</div>}

                            {!currentUser && <div className={styles.loginSignupButtonContainer}>
                                <div className={styles.loginButton} onClick={handleLoginSidebarOpen}>
                                    <p>Have an Account</p>
                                    <p>LOGIN</p>
                                </div>
                                <div className={styles.signupButton} onClick={handleSignupSidebarOpen}>
                                    <p>New to Swiggy</p>
                                    <p>SIGNUP</p>
                                </div>
                            </div>}
                            {currentUser && <div className={styles.loggedInUser}>
                        ...
                        <div className={styles.deliveryAdressInputDetails}>
                            ...
                            <div className={styles.inputAdress}>
                                ...
                                {currentUser && <textarea onChange={handleAddressInput} rows="4" cols="50" placeholder='Enter Your Full Address'>
                                </textarea>}
                            </div>
                        </div>
                        <div className={styles.paymentContainer}>
                            ...
                            <div className={styles.totalAmount}> Your total cart value is <strong>Rs {totalCartprice || 0}. </strong>
                                {!currentUser ? "Login to proceed your payment." : "Proceed to payment to confirm your order."}
                            </div>
                            {addressInput && currentUser && <div
                        ...
                        <div className={styles.cartItems_inner_container}>
                            <div className={styles.restaurantName_container}>
                                ...
                                <div className={styles.resturantNam_right_container}>
                                    <div className={styles.restaurantName_heading}>{cartItems[0]?.restaurantName}
                                    </div>
                                    <div className={styles.restaurantName_location}> {cartItems[0]?.area}
                                    </div>
                                    <div className={styles.restaurantName_underline}>
                            ...
                            <div className={styles.totalAmount_container}>
                                ...
                                <p className={styles.totalprice}>₹{Number(totalCartprice).toFixed(2) || 0}</p>
